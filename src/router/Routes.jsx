	...
	return (
		<BrowserRouter>
			<Switch>
				...
				<PrivateRoute path="/manage/campaign/edit/:slug/:uuid/home" component={Dashboard} />
				...
				<PrivateRoute path="/manage/did-pool/edit/:uuid" component={EditDidPool} />
				<PrivateRoute path="/manage/dids" component={ManageDIDs} />
				<PrivateRoute exact path="/manage/locations" component={ManageLocation} />
				<PrivateRoute path="/manage/locations/edit/:uuid/" component={LocationSettings} />
