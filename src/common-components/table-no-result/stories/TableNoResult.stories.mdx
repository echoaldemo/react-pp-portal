...
<Preview>
    <Story name="Default">
            <TableNoResult icon={<IoIosGlobe fontSize={46}/>} headerText="Global option groups" mainMessage="No global option groups have been created" subMessage="Would you like to creat one? Just hit the “New option group” button."
                renderButton={
