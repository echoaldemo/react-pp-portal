...
import { TableRow, TableCell, withStyles, Tooltip } from "@material-ui/core";
import { Settings, FileCopyOutlined as Icon } from "@material-ui/icons";
...
```
import { UnderlineCell } from "common-components"
```
<Preview>
...
## With Live Cell
```
import { LiveCell } from "common-components"
```
<Preview>
...
## With Truth Cell
```
import { TruthCell } from "common-components"
```
<Preview>
...
## With Paused Cell
```
import { PausedCell } from "common-components"
```
<Preview>
