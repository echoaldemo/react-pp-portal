                              ...
                              >
                                <Grid item>
                                  ...
                                  <span
                                    id={`rerecordBtn-${i}`}
                                    onClick={() =>
                                      this.openRerecord(row.name, row)
                                    }
                                      ...
                                      return (
                                        ...
                                        >
                                          <PlayAudioIcon
                                            className={classes.playIcon}
                                            onClick={() => {
                                              this.props.showLoader("recorded");
                                              this.props.playAudio(
                                                this.props.version,
                                                this.props.voice,
                                                row.key,
                                ...
                                {(() => {
                                  ...
                                  if (this.props.audio.length !== 0) {
                                    if (
                                      ...
                                      if (row.key) {
                                        if (
                                          this.props.audio.audio.key === row.key
                                        ) {
                                          return (
                                            <audio
                                              controls
