...
import { TableNoResult, SaveButton, Modal, InputField, LoadingModal } from 'common-components';
...
const AddNewPitch = () => {
	...
	return (
		<React.Fragment>
			...
			/>
			<Modal open={modalState} title={<b>Create New Pitch</b>} onClose={() => setModalState(false)}>
				<PitchForm />
			</Modal>
		</React.Fragment>
	);
