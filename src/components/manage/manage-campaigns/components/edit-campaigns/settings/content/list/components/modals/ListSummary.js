    ...
    return (
        <>
            <div className={classes.container}>
                <CustomTable
                    header={['Number of prospects', 'Resolved prospects', 'Qualified prospects', 'Active prospects']}
                    data={['5781', '1966', '0', '0']}
                />
                <CustomTable
                    header={['Callable prospects', 'Outbound attempted calls', 'Conversion', 'Schedule prospects']}
                    data={['0', '7796', '0.21%', '0']}
                />
                <CustomTable
                ...
                />
                <CustomTable
                    header={['Active penetration', 'Completion', 'Prospect contacted rate', 'Call contacted rate']}
