        ...
        <CardHeader
          ...
          action={
            <div style={{ marginTop: 7 }}>
              <Button disabled={queue.length === 0 ? true : false} onClick={cancelQueue}>
                Cancel
              </Button>
              <Button disabled={queue.length === 0 ? true : false} onClick={addToTeam}>
                Add
              </Button>
            </div>
          }
              ...
              <Table stickyHeader={true}>
                <TableBody>
                  {queue.map((user, i) => (
                    ...
                    >
                      <TableCell style={{ cursor: 'pointer' }} align="left" className={classes.name}>
