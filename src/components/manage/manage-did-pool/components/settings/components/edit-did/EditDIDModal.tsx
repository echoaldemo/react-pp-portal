  ...
  React.useEffect(() => {
    ...
    if (props.editData !== null) {
      ...
      if (props.editData.pool !== null) {
        ...
        get(
          `/identity/campaign/${props.editData.pool.campaign}/`
        ).then((res: any) => setCampaign(res.data));
        get(
          `/identity/company/${props.editData.pool.company}/`
        ).then((res: any) => setCompany(res.data));
      }
    }
