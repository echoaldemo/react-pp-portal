...
import TimeLine from "../billable-hours/TimeCard/TimeLine";
import LabelCard from "../billable-hours/TimeCard/LabelCard";
    ...
    data: [
      {
        ...
        endHours: 3,
        lateStart: 0,
        data: ["Rep session", "Session Info", "Start/Stop", "Number of calls"]
      },
      {
        title: [""],
        data: [],
          ...
          <Content>
            {mock.map((key: any, i: number) => {
              return (
                ...
                >
                  {key.data.map((ret: any, i: number) => (
                    <TimeCard
                      key={i}
                      mode={key.data.length > 1 ? "small" : "large"}
                      bgColor={
                        key.data.length > 1 && "rgba(68, 189, 148, 0.85)"
                      }
