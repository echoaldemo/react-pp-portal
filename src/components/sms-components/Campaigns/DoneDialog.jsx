...
import { Icon, Dialog, DialogTitle, DialogContent, IconButton, useMediaQuery
    ...
    return (
        ...
        <DialogTitle className={classes.dialogTitle} 
            ...
            >   <div className={classes.flex}>
                 ...
                 <span className={classes.span} style={{padding:10,width:280,textAlign:'center',marginLeft:30}}>
                     {props.message}
                 </span>
             ...
             <DialogContent align="center">
                ...
                <span><ErrorIcon style={{color: '#ff504d'}}/></span>
