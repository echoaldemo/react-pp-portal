...
interface Props {
  ...
  fallbackNumber: any;
  updateTransferCallback: any;
  origFallbackTimeOut?: any;
  origFallbackNumber?: any;
}
interface State {
  fallbackTimeOut: any;
  fallbackNumber: any;
...
class TransferCallback extends Component<Props, State> {
        ...
        >
          ...
          <Grid item xs={12} sm={4} md={3} lg={3}>
            ...
            this.state.fallbackNumber !== this.state.originalNumber ? (
              this.state.fallbackTimeOut.length !== 0 &&
              this.state.fallbackNumber.length !== 0 ? (
                <Button
                  variant="contained"
