...
interface State {
  ...
  repostRules: any;
  errorName: boolean;
  errorRevenue: boolean;
  LongTransferData: any;
  CloseLeadData: any;
  CloseDurationData: any;
  RepostRulesData: any;
  message: string;
  open: boolean;
  loaderDialog: boolean;
  originalname: any;
  originallongTransfer: any;
  originalcloseLead: any;
  originalcloseDuration: any;
  originalrevenue: any;
  originalsetLongTransfers: any;
  originalrepostRules: any;
  [x: number]: any;
}
interface Props {
  campaignDetails: any;
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} sm={6} md={6} lg={6}>
            ...
            <TextField
              ...
              margin="normal"
            >
              {this.state.LongTransferData.map((option: any, i: number) => (
                <MenuItem
                  key={option.value}
                  id={`longTransfer${i}`}
                  value={option.value}
            ...
            <TextField
              ...
              margin="normal"
            >
              {this.state.CloseLeadData.map((option: any, i: number) => (
                <MenuItem
                  key={option.value}
                  id={`closeLead${i}`}
                  value={option.value}
            ...
            <TextField
              ...
              margin="normal"
            >
              {this.state.CloseDurationData.map((option: any, i: number) => (
                <MenuItem
                  key={option.value}
                  id={`closeDuration${i}`}
                  value={option.value}
          ...
          <Grid item xs={12} sm={6} md={6} lg={6}>
            ...
            >
              {this.state.RepostRulesData.map((option: any, i: number) => (
                <MenuItem
                  key={option.value}
                  id={`repostRules${i}`}
                  value={option.value}
