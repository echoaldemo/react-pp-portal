...
storiesOf("Upload Design", module).add("default", function () {
    return (React.createElement(Upload, { limit: 8, accept: "audio/*", labelText: "Data File", helperText: "A file needed", getAudio: function (e) { return console.log("I am the file", e); } }));
});
// Value	Description
...
//# sourceMappingURL=upload.stories.js.map